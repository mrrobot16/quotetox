...
var QuoteDictService = (function () {
    function QuoteDictService() {
        this.quotes = [
            {
    ...
    QuoteDictService.prototype.get_quotes = function () {
        return this.quotes;
    };
    QuoteDictService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [])
    ], QuoteDictService);
    return QuoteDictService;
}());
exports.QuoteDictService = QuoteDictService;
