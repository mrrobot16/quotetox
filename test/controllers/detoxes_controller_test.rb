...
class DetoxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detox" do
    assert_difference('Detox.count') do
      post detoxes_url, params: { detox: { drug_name: @detox.drug_name, last_time: @detox.last_time, tox_free: @detox.tox_free } }, as: :json
    end
  ...
  test "should update detox" do
    patch detox_url(@detox), params: { detox: { drug_name: @detox.drug_name, last_time: @detox.last_time, tox_free: @detox.tox_free } }, as: :json
    assert_response 200
  end
